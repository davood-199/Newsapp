...
export default class App extends Component {
  render() {
    return (
      ...
      <Navbar/>
      <Routes>
          <Route exact path="/"element={<News key="everything" pageSize={5}country="in" category="everything"/>}/>        
          ...
          <Route exact path="/general"element={ <News key="genera" pageSize={5}country="in" category="general"/>}/>
